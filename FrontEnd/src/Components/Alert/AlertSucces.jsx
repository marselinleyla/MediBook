...
/*
 * AlertSucces.jsx — Success toast notification component
 * Props:
 *   - Message : string — the success text to display
 * Renders a fixed-position Flowbite Toast with a green checkmark
 * icon and a dismiss button. Automatically positioned at top-right.
 */
