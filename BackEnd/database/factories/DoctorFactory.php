 ...
 * DoctorFactory
 *
 * Generates fake doctor profiles for seeding.
 * Each doctor has a unique email and Matricule, random specialty,
 * work schedule (French day names), and 40-minute appointment slots.
...
class DoctorFactory extends Factory
{
  ...
  public function definition()
  {
    return [
      ...
      'appointment_time'=>'40' // Default 40 minutes per appointment slot
  ];
