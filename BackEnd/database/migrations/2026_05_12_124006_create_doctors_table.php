 ...
 *
 * Stores doctor profiles with personal info, professional details,
 * office address, work schedule, and verification status.
 * Fields: name, contact, Matricule (unique), specialite, cabinet info,
 * work days/hours, appointment duration, availability, verification.
 */
